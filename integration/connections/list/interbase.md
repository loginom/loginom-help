# ![](../../../images/icons/vendors/ibunidacdbconnection.svg) Подключение Interbase

Используется для подключения к базе данных Interbase. Чтобы подключиться к базе, пользователю необходимо инсталлировать клиент СУБД той же разрядности, что и клиент Loginom.
