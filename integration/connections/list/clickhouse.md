...
>   * Удаление по ключу работает только для таблиц с движком из семейства [MergeTree](https://clickhouse.yandex/docs/ru/operations/table_engines/#semeistva-dvizhkov). После того, как отработал экспорт с удалением по ключу, записи ещё могут существовать в исходной таблице, поскольку сервер ClickHouse удаляет записи отложенно, в фоне.
