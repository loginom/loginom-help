...
Используется для подключения к [Хранилищу данных](https://wiki.loginom.ru/articles/data-warehouse.html) [Deductor Warehouse](../../../data-format/data-warehouse.md), основанному на СУБД Microsoft SQL Server.
