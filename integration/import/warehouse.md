...
> `нужно ли контекстное меню или же удалить? если нужно, то описание продублировать?`

Контекстное меню дублирует общие функции: *Выводить*, *Удалить*, *Удалить все*, *Переместить вверх*, *Переместить вниз*.
...
* ![Удалить все](../../images/icons/toolbar-controls_18x18/toolbar-controls_18x18_delete-all_default.svg) **Удалить все**;
* ![Переместить вверх](../../images/icons/toolbar-controls_18x18/toolbar-controls_18x18_moveup_default.svg) **Переместить вверх**;
* ![Переместить вниз](../../images/icons/toolbar-controls_18x18/toolbar-controls_18x18_movedown_default.svg) **Переместить вниз**.
