...
* **Кол-во строк для анализа** — кол-во строк для анализа - задает количество строк набора по которым будет проводиться анализ типа данных. При этом максимальное число строк для отображения 200.
