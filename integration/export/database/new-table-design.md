...
* Поля таблицы с указанием следующих параметров:
  ...
  * Тип данных поля.
  * Размер (только для строкового поля) — максимальная длинна строки, по умолчанию установлен равным 50. Значение параметра, установленное по умолчанию, при необходимости следует скорректировать в соответсвии с экспортируемыми данными.
