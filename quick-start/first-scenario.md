...
После авторизации открывается окно выбора действий (Cтраница Начало), в котором можно выполнять следующие операции с пакетами.
...
1. Слева расположено главное меню с кнопками: Меню, Пакеты, Навигация, [Файлы](../location_user_files.md), [Процессы](../information_panel.md).
