...
Пройдем шаги мастера, указав в параметре "Имя файла" [местоположение файла](../glossary/location_user_files.md) Sales.ddf.
...
В результирующем сценарии добавляется узел экспорта и/или настраивается [визуализатор](../visualization/start.md) результатов (см. рисунок 6).
