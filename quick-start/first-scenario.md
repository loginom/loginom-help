...
![Рисунок 1. Рабочее пространство Loginom 6.0](./first-scenario_1.png)
...
![Рисунок 2. Область построения сценария и Панель "Компоненты"](./first-scenario_2.png)
...
* импорт из файла [Sales.txt](./Sales.txt) информации о продажах;
...
![Рисунок 3. Вызов мастера настройки узла](./first-scenario_3.png)
...
![Рисунок 4. Вызов быстрого просмотра](./first-scenario_4.png)
...
![Рисунок 5. Формирование связи](./first-scenario_5.png)
...
![Рисунок 6. Результирующий сценарий](./first-scenario_6.png)
...
![Рисунок 7. Выделение блока узлов](./first-scenario_7.png)

*Рисунок 7. Выделение блока узлов*

![Рисунок 8. Преобразование блока узлов в подмодель](./first-scenario_8.png)
...
![Рисунок 9. Сохранение пакета](./first-scenario_9.png)
