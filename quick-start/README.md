...
Для решения задач анализа [**Loginom**](https://loginom.com) позволяет импортировать данные из различных источников и применять к ним необходимые алгоритмы обработки. Результаты можно просмотреть в самой системе или экспортировать в сторонние приемники данных.
...
Одной из основных концепций, на которых базируется платформа [**Loginom**](https://loginom.com), является [Сценарий](./first-scenario.md).
