...
|Аутентификация|Выбор способа аутентификации пользователя: Локальная или [LDAP](./parameters.md#parametry-ldap). |
...
> * При включенной LDAP аутентификации возможно автоматическое добавление пользователя в Loginom в случае успешной аутентификации.
