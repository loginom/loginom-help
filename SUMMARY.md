* [Начало работы](/quick-start/README.md)
  * [Основные принципы](/quick-start/basic-concepts.md)
  * [Структура пакета](/quick-start/package.md)
  * [Первый сценарий](/quick-start/first-scenario.md)
  * [Работа с базами данных](/quick-start/database.md)
  * [Основы проектирования сценариев](/quick-start/scenario-construction.md)
...
* [Интеграция](/integration/README.md)
  ...
  * [Импорт данных](/integration/import/README.md)
    ...
    * [База данных](/integration/import/bd.md)
    * [Тестовый файл](/integration/import/txt_csv.md)
...
* [Обработка данных](/processors/README.md)
  * [Обработчики](/processors/README.md)
    * [Трансформация](/processors/transformation/README.md)
      ...
      * [Слияние](/processors/transformation/join.md)
      * [Соединение](/processors/transformation/addition.md)
      * [Сортировка](/processors/transformation/sorting.md)
      * [Фильтр строк](/processors/transformation/row_filter.md)
    * [Управление](/processors/control/README.md)
      * [Выполнение узла](/processors/control/execute_node.md)
...
* [Данные](/data/README.md)
  ...
  * [Вид данных (непрерывный, дискретный)](data/data/datakind.md)
