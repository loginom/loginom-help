  ...
  * [Обработчики](./processors/README.md)
    * [Трансформация](./processors/transformation/README.md)
      ...
      * [JavaScript](./processors/transformation/java-script/README.md)
        * [Импорт внешних модулей](./processors/transformation/java-script/external_modules.md)
        * [Доступ к входным наборам](./processors/transformation/java-script/input_tables.md)
        * [Доступ к входным переменным](./processors/transformation/java-script/input_variables.md)
        * [Доступ к выходному набору](./processors/transformation/java-script/output_table.md)
        * [Необходимые перечисления](./processors/transformation/java-script/enum.md)
        * [Доступ к функциям Калькулятора](./processors/transformation/java-script/calc_functions.md)
