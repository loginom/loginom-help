...
* [Обработка данных](./processors/README.md)
  * [Обработчики](./processors/README.md)
    * [Трансформация](./processors/transformation/README.md)
      ...
      * [Python](./processors/transformation/python/README.md)
        * [Внешние модули](./processors/transformation/python/external-modules.md)
        * [Входные наборы](./processors/transformation/python/input-tables.md)
        * [Входные переменные](./processors/transformation/python/input-variables.md)
        * [Выходной набор](./processors/transformation/python/output-table.md)
        * [Перечисления](./processors/transformation/python/enum.md)
        * [Консоль отладки кода](./processors/transformation/python/console.md)
        * [Описание API](./processors/transformation/python/api-description.md)
        * [Горячие клавиши](./processors/transformation/python/hotkeys.md)
