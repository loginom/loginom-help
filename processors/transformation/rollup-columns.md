...
Выполним свертку столбцов. Поля `Код клиента` и `Месяц` выберем как *Информационные*. А `Кол-во SMS` (![Переменный](../../images/icons/datatype_18/datatype_default-02.svg)Целый тип), `Кол-во минут вх` (![Переменный](../../images/icons/datatype_18/datatype_default-02.svg)Целый тип), `Статус` (![Переменный](../../images/icons/datatype_18/datatype_default-01.svg)Строковый тип), `Наличие скидки` (![Переменный](../../images/icons/datatype_18/datatype_default-04.svg)Логический тип), веберем *Траспонируемыми*.
