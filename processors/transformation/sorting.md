...
* **Регистр данных** — у поля со ![Строковый тип](../../images/icons/datatype_18/datatype_default-01.svg)*Строковым типом* данных указывается его регистрозависимость при сортировке.
