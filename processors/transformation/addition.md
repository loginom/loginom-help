...
К исходному набору можно присоединять переменные. Каждая из присоединяемых переменных добавляет новый столбец к исходному набору. При этом в зависимости от настроек параметра *Дополнение до наибольшего набора*, все строки нового столбца будут содержать значение присоединенной переменной, либо значение переменной будет только в первой строке, а в остальных - null.
