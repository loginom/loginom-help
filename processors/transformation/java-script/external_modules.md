...
В модулеях ES6 поддерживается статический и динамический импорт модулей ES6, для вызова модуля CommonJS применяется функция **require** (см. [Полное описание API](./api_description.md)).
