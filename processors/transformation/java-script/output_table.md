...
Для доступа к данным выходного порта используются объект OutputTable, для которого определены следующие свойства и методы:
...
// В поле с индексом 1 записывается текущие Дата/Время
