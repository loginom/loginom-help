...
> **Важно:** Неперехваченные ошибки в [Promise](https://learn.javascript.ru/promise) записываются в лог сервера, а выполнение узла продолжается без сообщений об ошибке.