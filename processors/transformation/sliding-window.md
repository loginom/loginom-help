...
Для поля `Продажи, шт.` настроим параметр *Глубина истории* равным двум, а параметр *Горизонт прогноза* — равным единице. Параметр *Оставлять неполные записи* выберем как *Оставлять неполные записи*.
