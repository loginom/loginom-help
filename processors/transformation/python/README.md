...
* Должна использоваться библиотека python3*.dll с полным API, которая содержит номер минорной версии в названии. По умолчанию автоматически находится и используется библиотека максимальной версии. В разделе [Администрирование->Параметры](../../../admin/parameters.md) можно указать путь к библиотеке необходимой версии.
