# ![](../../images/icons/vendors/binning.svg) Квантование
...
* ![](../../images/icons/) Редактировать — при нажатии позволяет редактировать параметры квантования для выбранного поля;
...
* ![](../../images/icons/) — Пересчитывает гистограмму согласно новым параметрам.
