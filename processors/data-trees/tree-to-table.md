...
Данные, поданые во входной порт узла,  представлены в нем виде входного и выходного наборов.
...
#### Задание структуры выходного набора вручную

При задании структуры выходного дерева вручную используются команды на панели инструментов или контекстного меню.  
...
#### Загрузка структуры узлов из файла *.xsd

Структуру выходного дерева можно загрузить из файла *.xsd с помощью команды ![](../../images/icons/toolbar-controls/import-from-xsd_default.svg) **Загрузить из XSD...**

В появившемся диалоговом окне необходимо заполнить поля:

* **XSD файл** — поле для выбора *.xsd-файла (не редактируемое).
* **Пространство имен** — выбор пространства имен из списка всех пространств имен описанных в *.xsd-файле, ограничивает выбор корневого элемента только указанным пространством. По умолчанию принимает значение **Все пространства имен**.
* **Корневой элемент** — выбор корневого узла из списка в загруженном *.xsd-файле. По умолчанию имеет значение первого корневого узла выбранного файла.
