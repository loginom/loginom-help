...
>**Важно:** при раскрытии узлов дерева (в том числе и первоначальное построение дерева) есть ограничение числа раскрываемых узлов. Оно равно 4096, то есть, если число узлов превысит это количество, то остальные узлы не будут раскрыты ( в дереве будут отсутствовать их дочерние узлы), их можно будет раскрыть вручную в мастере настройки.
