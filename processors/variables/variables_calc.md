# ![ ](../../media/app/icons/component_18/component_default-21.svg) Калькулятор (переменные)
...
Наименование, входные аргументы и описание [доступных для использования функций](../transformation/calc.md).
...
Обработчик "Калькулятор" использует механизм w, это означает, что расчет производится, только когда значение выражения отображается или используется другим узлом сценария.
