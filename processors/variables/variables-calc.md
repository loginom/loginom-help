# ![ ](../../media/app/icons/component-18/component-default-21.svg) Калькулятор (переменные)
...
* ![](../../media/app/icons/ports/output-variable-inactive.svg) Выходные переменные - входные переменные и новые переменные, вычисленные обработчиком.

## Мастер настройки

Окно настроек содержит области:

 1. [Список выражений](#список-выражений)
 2. [Область кода выражения](#область-кода-выражения)
 3. [Переменные](#переменные)
 4. [Список функций](#список-функций)
