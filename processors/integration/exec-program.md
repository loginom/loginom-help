...
* **Тайм-аут выполнения узла** (мсек.) — устанавливает время выполнения узла:
  ...
  * **Бесконечность** — в этом случае узел будет выполняться до тех пор, пока программа не будет закрыта. Чтобы установить время выполнения программы бесконечность необходимо в поле тайм-аута ввести либо -1, либо удалить все цифры.
