...
В Desktop и серверной версии Loginom, если проект сохранен, то текущий каталог совпадает с каталогом, где находится пакет.

>**Примечание:** Производный узел, так же как и любой другой узел работает в контексте того пакета, в котором он находится, т.е. текущий каталог [файлового хранилища](../../location_user_files.md) для производного узла будет текущий каталог пакета, в котором находится именно производный узел, а не базовый.
