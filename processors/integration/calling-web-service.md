...
Перед началом настройки требуется установить связь с узлом [поключения к веб-сервису](../../integration/connections/list/web-service.md). Настройка включает несколько шагов.
