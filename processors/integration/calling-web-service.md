# ![ ](../../images/icons/data-sources/web-soap-client_default.svg) Вызов веб-сервиса
...
Перед началом настройки требуется установить связь с узлом [подключения к веб-сервису](../../integration/connections/list/web-service.md). Настройка включает несколько шагов.
