...
* ![](../../images/icons/ports/output_table_inactive.svg) — **Выход модели.**
...
* ![](../../images/icons/ports/output_table_inactive.svg) — **Коэффициенты модели.**
...
* ![](../../images/icons/ports/output_variable_inactive.svg) — **Сводка**
...
* ![](../../images/icons/usage-types/active_default.svg) **Входное** — поля, соответствующие дополнительным входным факторам;
* ![](../../images/icons/usage-types/predicted_default.svg) **Участвующее в прогнозе** — поле, соответствующее временному ряду;
