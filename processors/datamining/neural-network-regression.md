...
* в полях, обозначаемых как *выходные* — соответствующие входным параметрам значения [зависимых переменных](https://wiki.loginom.ru/articles/output-variable.html).
...
* ![ ](../../images/icons/app/node/ports/outputs/table_inactive.svg) Выход нейросети (таблица данных) – к входному набору данных добавляются поля с прогнозируемыми значениями Имя_поля|Прогноз.  
...
* ![ ](../../images/icons/usage-types/predicted_default.svg) **Выходное** — поле содержит целевые значения.
* ![ ](../../images/icons/usage-types/unspecified_default.svg) **Не задано** — поле не участвует в обработке. Устанавливается по умолчанию для прочих полей.
