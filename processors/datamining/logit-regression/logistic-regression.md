...
>**Важно:** [Входные данные](https://wiki.loginom.ru/articles/input-variable.html) никогда не должны содержать пропусков, [выходные данные](https://wiki.loginom.ru/articles/output-variable.html) не должны содержать пропусков во время обучения.
