...
**Логистическая регрессия** — это разновидность множественной регрессии, общее назначение которой состоит в анализе линейной связи между несколькими [независимыми](https://wiki.loginom.ru/articles/input-variable.html) переменными и [зависимой](https://wiki.loginom.ru/articles/output-variable.html) переменной.
