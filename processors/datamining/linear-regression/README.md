...
### Выходы
* ![](../../../images/icons/ports/output_table_inactive.svg) — Выход регрессии — таблица, состоящая из следующих полей полей: регрессия поля выходных данных, поля исходного набора данных;
