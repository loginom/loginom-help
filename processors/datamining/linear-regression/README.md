...
* Метод [валидации](../../validation.md), который может принимать   следующие значения:
  ...
  * [Монте-Карло](https://wiki.loginom.ru/articles/monte-carlo-technique.html?q=) — метод, определенное количество раз случайным образом разбивающий исходный набор данных на обучающую и валидационную выборку в заданной пропорции. Размер обучающего и валидационного множества может быть определен в процентах или строках, либо задан с помощью переменных.
