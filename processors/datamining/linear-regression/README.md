...
* ![](../../../images/icons/ports/input_variable_inactive.svg) Управляющие переменные (переменные) — необязательный порт. По умолчанию скрыт. При добавлении данного порта становится возможным задавать с помощью переменных некоторые блоки параметров.   
