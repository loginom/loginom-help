# ![](../../media/app/icons/vendors/classifierneuralnet.svg) Нейросеть (классификация)
...
В задаче классификации (в отличии от [задачи регрессии](../../processors/datamining/neural_network_regression.md)) **выходным** может быть только поле с дискретным [видом данных](../../data/datatype.md). Вид данных входных полей не регламентируется, они могут быть как непрерывными, так и дискретными.
