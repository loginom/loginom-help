...
Командой *Настроить порт* открывается диалог: 

* для входных портов *Настройка соответствия между столбцами* или *Настройка переменных* в зависимости от типа порта; 
* для выходных портов *Настройка выходных столбцов* или *Настройка выходных переменных* в зависимости от типа порта.
