...
* ![](../../images/icons/ports/input_table_inactive.svg) Табличные данные;
...
* ![](../../images/icons/ports/input_model_inactive.svg) Структура данных не определена.
...
* ![](../../images/icons/ports/input_table_active.svg) — порт выполняется;
* ![](../../images/icons/ports/input_table_inactive.svg) — порт сконфигурирован, но не выполняется;
* ![](../../images/icons/ports/input_table_error.svg) — порт не сконфигурирован или содержит ошибку;
* ![](../../images/icons/ports/input_table_warning.svg) — порт частично сконфигурирован.

Необязательный порт отображается пунктиром (цветовая индикация для них аналогична обязательным портам)
![](../../images/icons/ports/optional_output_table_inactive.svg)
