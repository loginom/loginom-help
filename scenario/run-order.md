...
Иногда необходимо вручную задать последовательность выполнения узлов в Сценарии. Для этого используются ![](../images/icons/app/node/ports/port-order/port-order_inactive.svg).

Для задания последовательности выполнения Сценария используют порт порядка выполнения (см. рисунок 3):

![Пример использования служебных портов.](./ports/service-port-1.png)
