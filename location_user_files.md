# ![](./images/icons/system_toolbar_48x48/controls-filestorage_default.svg) Файловое хранилище
...
Файловый менеджер вызывается по кнопке ![](./images/icons/system_toolbar_48x48/controls-filestorage_default.svg) основного меню работы с файлами и предоставляет необходимый инструментарий для работы с файловым хранилищем.
