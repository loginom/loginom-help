...
Визуализатор *Отчет по регрессии* компонента [*Линейная регрессия*](../../processors/datamining/linear-regression/README.md) отображает статистические параметры и результаты статистических тестов для анализа регрессионных моделей.
...
|![Вещественный](../../images/icons/data-types/float_default.svg) R^2 корр.|[Коэффициент детерминации скорректированный](https://wiki.loginom.ru/articles/coefficient-determ-adj.html)|
