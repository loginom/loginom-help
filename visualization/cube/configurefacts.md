...
Действия, выполняемые пользователем, аккумулируются в окне *Настроить факты*. Таким образом, можно настроить несколько фактов и все изменения одновременно будут внесены в *Куб* после нажатия кнопки *Применить*.
