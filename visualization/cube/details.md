...
* **Таблица** — данные будут представлены визуализатором [Таблица](../table/README.md), но без возможности фильтрации и без панели детализации;
* **Форма** — соответствует панели детализации из визуализатора *Таблицы* с добавленной возможностью перехода к между значений;
* **Статистика** — данные будут представлены визуализатором [Статистика](../statistics/README.md) без изменений.
