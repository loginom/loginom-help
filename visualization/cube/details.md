...
Для быстрой сортировки можно нажать на заголовок нужного поля. При последовательном нажатии будут применены варианты: по возрастанию, по убыванию, без сортировки. Сортировку можно произвести по нескольким полям. При этом, порядок будет указан цифрой в заголовке.
