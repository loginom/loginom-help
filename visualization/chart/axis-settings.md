...
* **Нижняя:**
  ...
  * Поле X — задается поле для оси X. Нажатие на ![Удалить](../../media/app/icons/toolbar_18/toolbar_18_8.svg) удаляет ранее выбранное поле.
  * Поле меток — поле для задания обозначений делений оси X. Нажатие на ![Удалить](../../media/app/icons/toolbar_18/toolbar_18_8.svg) удаляет ранее выбранное поле.
