...
* **Порядок** - в ячейках этого поля отображется тумблер, который отображает вид сортировки, он может принимать значения по возрастанию ![](../../media/app/icons/toolbar-18/sorting-order-01.svg) или по убыванию ![](../../media/app/icons/toolbar-18/sorting-order-02.svg);
* **Регистр** - в ячейках этого поля, при условии что сортируемые значения строкового типа, отображается чекбокс. Для сортировки строковых полей с учетом регистра у нужных полей нужно проставить в чекбокс флажек.
