# ![](../../images/icons/toolbar-controls_18x18/toolbar-controls_18x18_format_default.svg) Формат
...
По умолчанию поля выводятся в таблицу в том же порядке, что и в исходном наборе данных. Если порядок полей менялся, его можно восстановить до исходного. Для этого необходимо нажать кнопку ![](../../images/icons/toolbar-controls_18x18/toolbar-controls_18x18_refresh-all_default.svg) *Восстановить порядок полей*.
