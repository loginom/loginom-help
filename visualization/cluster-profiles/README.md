...
*Профили кластеров* — этот визуализатор позволяет определить структуру кластеров и сравнить их между собой, отображает общую статистику по кластерам.
...
4. **[Панель инструментов](./toolbar.md)** — настройка отображаемых данных;
