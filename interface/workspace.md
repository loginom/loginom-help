...
* ![](../images/icons/toolbar-controls/info_default.svg) Показать/скрыть [инспектор свойств](../../data/interface/property-inspector.md) — разворачивает/сворачивает окно *Инспектора свойств*. Эта кнопка всегда находится в крайней правой позиции на  панели инструментов.
